/*
  ...
  Modified for RAMPS 1.7 
  *** Y-axes ***** 
  by MrAlvin sept 2018
*/
...
#define EN_PIN    58 //enable (CFG6)
#define DIR_PIN   63 //direction
#define STEP_PIN  62 //step


              //chip select (universal) (Uno: 10, Mega: 10, DUE: 52)
              //chip select (specific) X:46, Y:42, Z:48, E0:38, E1:6
#define CS_PIN   42   
#define MOSI_PIN 51 //SDI/MOSI (ICSP: 4, Uno: 11, Mega: 51, DUE: 75)
#define MISO_PIN 50 //SDO/MISO (ICSP: 1, Uno: 12, Mega: 50, DUE: 74)
#define SCK_PIN  52 //CLK/SCK  (ICSP: 3, Uno: 13, Mega: 52, DUE: 76)
...
void loop()
{
  ...
  if((ms-last_time) > 1500) //run every 1.5s
  {
    last_time = ms;
